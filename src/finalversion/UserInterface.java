...
public class UserInterface {
  ...
  public void testData() {
    try {
      itemRegister.addItem("100004", "Plastic", 1000, 0, "TimberCraft", 10, 10, 10, "Fir green",
          10, 1);
      itemRegister.addItem("100000", "Engineered Wood", 100, 0, "GreyStone", 10, 100, 100,
          "Orange", 100, 1);
      itemRegister.addItem("100001", "Smooth", 100, 0, "Laminate", 10, 100, 100,
          "Yellow", 100, 1);
      itemRegister.addItem("100002", "Textured", 100, 0, "Laminate", 10, 100, 100,
          "Green", 100, 1);
      itemRegister.addItem("200000", "Window", 400, 0, "Andersen", 5, 100, 100, "Orient red",
          100, 2);
      itemRegister.addItem("200001", "Stained window", 400, 0, "Marvin", 5, 50, 50, "Black",
          100, 2);
      itemRegister.addItem("200002", "Small window", 250, 0, "Window", 5, 50, 50, "White",
          100, 2);
      itemRegister.addItem("300000", "Old door", 500, 0, "Door", 10, 100, 200, "White",
          100, 3);
      itemRegister.addItem("300001", "Modern door", 500, 0, "Door", 10, 100, 200, "Black",
          100, 3);
      itemRegister.addItem("300002", "Plain door", 500, 0, "Door", 10, 100, 200, "Brown",
          100, 3);
      itemRegister.addItem("400000", "2x4 Planks", 100, 0, "Carrier Lumber", 10, 100, 100, "Brown",
          100, 4);
      itemRegister.addItem("400001", "1x4 Planks", 300, 0, "Edgewood Lumber", 10, 500, 500,
          "Yellow",
          100, 4);
      itemRegister.addItem("400002", "4x4 Planks", 500, 0, "Plum Creek Lumber", 10, 1000, 1000,
          "Green",
          100, 4);
    } catch (Exception e) {
  ...
  public void addItem() {
    ...
    while (i == 0) {
      ...
      if (itemCategory != null) {
        ...
        try {
          itemRegister.addItem(itemNumber, description, price, discount, brandName, weight, length,
  ...
  public void getItem() {
    ...
    String itemNumber = scanner.nextLine();
    try {
      Item item = itemRegister.getItem(itemNumber);
  ...
  public void getItemBasedOnDescription() {
    ...
    String description = scanner.nextLine();
    try {
      Item item = itemRegister.getItemBasedOnDescription(description);
      System.out.println(item);
    } catch (Exception e) {
      System.out.println(e.getMessage());
    }
  ...
  public void getItemList() {
    ...
    System.out.println(itemRegister.getItemList());
  }
  ...
  public void getAllItemsInCategory() {
    ...
    try {
      if (itemCategory != null) {
        ...
        System.out.println(itemRegister.getItemListForCategory(updateCategory(itemCategory)));
      } else {
        System.out.println("Invalid choice. Please enter a number 1 and 4.");
      }
  ...
  public void getNumberOfItems() {
    System.out.println(
        "Number of items in the warehouse: " + itemRegister.getTotalNumberOfItems());
  }
      ...
      if (itemCategory != null) {
        System.out.println(
            "Number of items in the warehouse in the category " + itemCategory.getCategoryName()
                + ": " + itemRegister.getNumberOfItemsInCategory(updateCategory(itemCategory)));
      } else {
        System.out.println("Invalid choice. Please enter a number 1 and 4.");
      }
    } catch (Exception e) {
  ...
  public void increaseAmountInStorage() {
    ...
    while (i == 0) {
      ...
      scanner.nextLine();
      try {
        itemRegister.increaseAmountInStorage(itemNumber, amount);
        System.out.println("Amount in storage was successfully increased.");
        System.out.println(itemRegister.getItem(itemNumber).smallToString());
      } catch (Exception e) {
        System.out.println(e.getMessage());
        i = tryAgain();
      }
  ...
  public void decreaseAmountInStorage() {
    ...
    while (i == 0) {
      ...
      scanner.nextLine();
      try {
        itemRegister.decreaseAmountInStorage(itemNumber, amount);
  ...
  public void sortItemsByAscendingPrice() {
    ...
    System.out.println(itemRegister.sortItemsByAscendingPrice());
  }
  ...
  public void sortItemsByDescendingPrice() {
    ...
    System.out.println(itemRegister.sortItemsByDescendingPrice());
  }
  ...
  public void updatePrice() {
    ...
    while (i == 0) {
      ...
      scanner.nextLine();
      try {
        itemRegister.updatePrice(itemNumber, price);
        if (itemRegister.getItem(itemNumber) != null) {
  ...
  public void updateDiscount() {
    ...
    while (i == 0) {
      ...
      scanner.nextLine();
      try {
        itemRegister.updateDiscount(itemNumber, discount);
        if (itemRegister.getItem(itemNumber) != null) {
  ...
  public void itemOffSale() {
    ...
    while (i == 0) {
      ...
      String itemNumber = scanner.nextLine();
      try {
        itemRegister.itemOffSale(itemNumber);
        if (itemRegister.getItem(itemNumber) != null) {
  ...
  public void updateItemDescription() {
    ...
    while (i == 0) {
      ...
      String description = scanner.nextLine();
      try {
        itemRegister.updateItemDescription(itemNumber, description);
        if (itemRegister.getItem(itemNumber) != null) {
  ...
  private int updateCategory(ItemCategory itemCategory) {
    int category = 0;
    if (itemCategory != null) {
      switch (itemCategory) {
